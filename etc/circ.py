...
if __name__ == '__main__':
    pts = numpy.array([[-5.0, 4.0], [-2.0, 4.0], [-5.0, 2.0], [-2.0, -1.0], [0.0, 1.0], [2.0, 1.0], [2.1, 10]])
    lastpt = pts[0]
    pylab.clf()
