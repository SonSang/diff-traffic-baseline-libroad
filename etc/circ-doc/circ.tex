...
\begin{align}
  ...
  \mathbf{r}^{-}_{i} &= c_{i} - \left(-\alpha\mathbf{n}_{i-1} - p_{i}\right)&=\pm r_i\left( --{\mathbf{n}_{i-1}}_{y},  -{\mathbf{n}_{i-1}}_{x} \right)\\
...
\begin{equation}
  \label{eq:bisector}
  \mathbf{b}_i = \frac{-\mathbf{n}_{i-1} + \mathbf{n}_i}{\left|-\mathbf{n}_{i-1} + \mathbf{n}_i\right|}
\end{equation}
%
...
\begin{equation}
  \label{eq:dotnorm}
  \mathbf{n}_{i} \cdot -\mathbf{n}_{i-1} = \cos 2\theta_i
\end{equation}
%
Similarly, we know
%
\begin{align}
  ...
  \label{eq:arclen-dot}
  &= 2\pi-\arccos \mathbf{n}_{i} \cdot -\mathbf{n}_{i-1}
\end{align}
%
...
\begin{align}
  ...
  r_{i} &= \alpha_i\sqrt{\frac{1-\mathbf{n}_i\cdot -\mathbf{n}_{i-1}}{1+\mathbf{n}_i\cdot -\mathbf{n}_{i-1}}}
\end{align}
%
